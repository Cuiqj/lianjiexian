...
- (void)viewDidLoad
{
    [self.textpostalcode setHidden:YES];
    [self.labelpostalcode setHidden:YES];
...
- (void)pageLoadInfo{
    ...
    self.caseInquire.locality = [self.caseInquire.locality stringByReplacingOccurrencesOfString:@"m" withString:@"M"];
