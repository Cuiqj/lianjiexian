...
@property (weak, nonatomic) IBOutlet UILabel *LabelCitizenAdress;
@property (weak, nonatomic) IBOutlet UILabel *LabelCitizenPhone;

@property (weak, nonatomic) IBOutlet UILabel *LabelTableviewRemark;
