...
-(void)loadCaseInfoArray{
    ...
    if (caseInfo) {
        ...
        localityString = [NSString stringWithFormat:@"%@%@%@%@",roadName,caseInfo.side,stationString,caseInfo.place];
        localityString = [localityString stringByReplacingOccurrencesOfString:@"处" withString:@""];
...
// 生成默认的询问笔录///西部沿海的
-(NSString*)generateCommonInquireText1111{
    NSString* text = @"";
