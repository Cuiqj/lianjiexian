...
-(void)viewDidLoad{
    [self.Labelprover_place setHidden:YES];
    [self.textprover_place setHidden:YES];
    [self.textcitizen_duty setEnabled:NO];
...
//        self.caseProveInfo.event_desc = [self TextEventDesc];
        [self pageLoadInfo];
    }
    [super viewDidLoad];
}
