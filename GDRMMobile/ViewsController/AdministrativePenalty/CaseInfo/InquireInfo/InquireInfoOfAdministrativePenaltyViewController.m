...
//            self.caseDescription = [NSString stringWithFormat:@"我于%@驾驶%@%@行至%@%@%@,因%@发生交通事故导致损坏公路路产。",happenDate,citizen.automobile_number,citizen.automobile_pattern,roadName,caseInfo.side,stationString,caseInfo.case_reason];
            self.caseDescription = [NSString stringWithFormat:@"我于%@驾驶%@%@行至%@%@%@,因发生交通事故导致损坏公路路产。",happenDate,citizen.automobile_number,citizen.automobile_pattern,roadName,caseInfo.side,stationString];
