            ...
            if (indexPath.section==0) {
                ...
                if (self.viewLocal == 0) {
                    ...
                    if ([deformation.unit rangeOfString:@"米"].location != NSNotFound) {
                        ...
                        cell.assetQuantityLabel.text=[NSString stringWithFormat:@"%.2f%@",deformation.quantity.floatValue,deformation.unit];
                    }
                }
...
//        NSPredicate *predicate=[NSPredicate predicateWithFormat:@"(proveinfo_id == %@) && (citizen_name == %@)",self.caseID,citizenName];
        NSPredicate *predicate=[NSPredicate predicateWithFormat:@"proveinfo_id == %@",self.caseID];
